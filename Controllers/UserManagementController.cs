...
";
        ...
        private string TranslateMenuKey(string key)
        {
            ...
            var controllerTh = controller switch
            {
                ...
                "TestScenarioTemplates" => "แม่แบบทดสอบ",
                "TestTemplateGroups" => "กลุ่มแม่แบบ",
                "TestTemplateGroupControls" => "ชุดแม่แบบ",
                "Settings" => "Settings",
            ...
            var actionTh = action switch
            {
                ...
                "Show" => "ดูรายละเอียด",
                "Create" => "เพิ่ม",
                "Result" => "ส่งผลการเข้าปฏิบัติงาน",
                "Calendar" => "ปฏิทินงานบริการ",
                "Report" => "รายงานงานบริการ",
                "GroupCreate" => "สร้าง Group ปฏิทิน",
                "CalendarCreate" => "สร้าง Calendar",
                "Edit" => "แก้ไข",
                "GroupEdit" => "แก้ไข Group ปฏิทิน",
                "CalendarEdit" => "แก้ไข Calendar",
                "Toggle" => "เปิด/ปิดสถานะ",
                "Delete" => "ลบ",
                "GroupDelete" => "ลบ Group ปฏิทิน",
                "CalendarDelete" => "ลบ Calendar",
                "DeleteAll" => "ลบทั้งหมด",
                "Details" => "รายละเอียด",
                "Upload" => "อัปโหลด",
                "Preview" => "ดูไฟล์",
