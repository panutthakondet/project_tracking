    ...
    public static class LineNotificationFeatures
    {
        ...
        public static readonly IReadOnlyList<LineNotificationFeatureDefinition> All =
            new List<LineNotificationFeatureDefinition>
            {
                ...
                new(FieldServiceAuto, "Field Service", "Auto Field Service", "ส่ง LINE อัตโนมัติสำหรับเตือนงานเข้าไซต์ล่วงหน้า"),
                new(FieldServiceCreate, "Field Service", "Create Field Service", "ส่ง LINE เมื่อสร้างและมอบหมายงานเข้าไซต์"),
                new(FieldServiceUpdate, "Field Service", "Edit Field Service", "ส่ง LINE เมื่อแก้ไขหรือย้ายกำหนดการงานเข้าไซต์"),
                new(FieldServiceCancel, "Field Service", "Cancel Field Service", "ส่ง LINE เมื่อยกเลิกงานเข้าไซต์"),
                new(FieldServiceReminder, "Field Service", "Field Service Reminder", "ส่ง LINE เตือนงานเข้าไซต์ล่วงหน้า 3, 2, 1, 0 วัน"),
